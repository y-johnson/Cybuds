...
public class Login extends AppCompatActivity {
	private static String responseContainer;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        tb_password.setText("Response is: "+ response.substring(0,500));
                    }
                }, new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        tb_password.setText("GET didn't work!");
                    }
        });
...
*/
		...
		try {
			...
			post.put("passwordHash", tb_password.getText());
		...
		JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, post, new Response.Listener<JSONObject>() {
			...
			public void onResponse(JSONObject response) {
				...
				try {
					...
					Intent toProfile = new Intent(Login.super.getBaseContext(), ProfileActivity.class);
